...
if (isset($_GET['id'])) {
	...
	if ($service_data !== null) {
		$data = array(
			...
			'content' => $service_data['compareitemleft'] . " OR " . $service_data['compareitemright'],
					...
					<div class="phone-content">
						...
						<div class="compare-image-container">
							<div class="image-container">
								<img class="compare-image" src="<?php echo $data['image1']; ?>" alt="Image1" title="Image1" /><br />
								<span class="compare-title"><?php echo $data['compareitemleft']; ?></span><br />
								<div class="image-title"><button disabled="disabled"><?php echo $data['nnumber_content']; ?></button></div>
							</div>
							<div class="image-divider"><img src="images/versus_button.png" /></div>
							<div class="image-container">
								<img class="compare-image" src="<?php echo $data['image2']; ?>" alt="Image2" title="Image2" /><br />
								<span class="compare-title"><?php echo $data['compareitemright']; ?></span><br />
								<div class="image-title"><button disabled="disabled"><?php echo $data['pnumber_content']; ?></button></div>
							</div>
